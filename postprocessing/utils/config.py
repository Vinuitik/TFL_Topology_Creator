...
OLLAMA_STREAM_READ_TIMEOUT_SEC = float(os.getenv("OLLAMA_STREAM_READ_TIMEOUT_SEC", "30"))
...
POST_PHASE_TIMEOUT_MINS = int(os.getenv("POST_PHASE_TIMEOUT_MINS", "15"))
POST_MAX_WORKERS = int(os.getenv("POST_MAX_WORKERS", "5"))
